boilerAdmin.directive('chartStatus1', function () {
    return {
        restrict: 'E',
        templateUrl: "/directives/chart_status1.html",
        controller: "ChartStatus1Controller",
        controllerAs: "s1Chart"
    };
}).controller("ChartStatus1Controller", function ($rootScope, $scope, $http) {
    var bChart = this;
    ...
    bChart.refreshChart = function (range, keys) {
        ...
        switch (range) {
            ...
            case RUNTIME_RANGE_WEEK:
                ...
                Ladda.create(document.getElementById('s1Chart' + range)).start();
                $http.post('/boiler_runtime_list/', postData).then(function (res) {
                    ...
                    Ladda.create(document.getElementById('s1Chart' + range)).stop();
                });
                break;
