 ...
 */
boilerAdmin.directive('chartTemperature', function () {
    return {
        restrict: 'E',
    ...
    bChart.initChart = function () {
        ...
        chart.graphs = [{
            ...
            id:"g2",
            valueField: "smokeH",
            balloonText: "排烟温度(高):[[value]] ℃",//"[[category]]<br><b><span style='font-size:14px;'>[[value]]</span></b>",
            bullet: "round",
            bulletSize: 4,
            lineColor: "#F3C200",
            lineThickness: 1,
