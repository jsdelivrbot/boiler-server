...
angular.module('BoilerAdmin').controller('ModalEditTemplateCtrl', function ($rootScope,$scope, $uibModalInstance,$http,currentData,editing) {
    ...
    $http.post("/template_info",{uid:$modal.currentData.Uid}).then(function (res) {
        $modal.templatesData = res.data;
        /*for(var i = 0 ; i<$modal.templatesData.length; i++){

        }*/
    },function (err) {
        console.error("模板获取错误", err.data);
    });
